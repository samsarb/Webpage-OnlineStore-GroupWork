...
<body>
    ...
    <div class="ProductPage">
        ...
        <img src="images/j02.jpg">
        <br>
        <a href="http://localhost:7331/part3/product.php?id=12"> Pearl necklace </a>
        <p> Price: $149.00 </p>
        <br><br>
    ...
    <!--second product-->
    <div class="ProductPage">
        <img src="images/j03.jpg">
        <br>
        <a href="http://localhost:7331/part3/product.php?id=13"> Turquoise bracelet </a>
        <p>Price: $149.99 </p>
        <br><br>
    ...
    <!--third product-->
    <div class="ProductPage">
        <img src="images/J01.jpg">
        <br>
        <a href="http://localhost:7331/part3/product.php?id=14"> Ring of Life </a>
        <p>Price: $109.99 </p>
