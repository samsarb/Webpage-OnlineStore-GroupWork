...
<head>
    <title>ADD-ON : Men's Watches </title>
</head>
<!--body section-->
...
<body>
    ...
    <div class="ProductPage">
        ...
        <img src="images/Watches1.jpg">
        <br>
        <a href="http://localhost:7331/part3/product.php?id=1">Midnight Blue Model 2L </a>
        <p> Price: $69.99 </p>
        <br><br>
    ...
    <!--second product-->
    <div class="ProductPage">
        <img src="images/watches2.jpg">
        <br>
        <a href="http://localhost:7331/part3/product.php?id=2">Bronze White Model 4S</a>
        <p>Price: $129.99 </p>
        <br><br>
    ...
    <!--third product-->
    <div class="ProductPage">
        <img src="images/watches3.jpg"><br></br>
        <br>
        <a href="http://localhost:7331/part3/product.php?id=3">Silver Gold Model 6Z</a>
        <p>Price: $139.99 </p>
