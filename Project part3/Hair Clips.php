...
<body>
    ...
    <div class="ProductPage">
        ...
        <img src="images/H 01.jpg">
        <br>
        <a href="http://localhost:7331/part3/product.php?id=15"> Black Blossom Hair Clips </a>
        <p> Price: $99.99 </p>
        <br><br>
    </div>
    ...
    <div class="ProductPage">
        ...
        <br>
        <a href="http://localhost:7331/part3/product.php?id=16"> Triple Girl Hair Clips </a>
        <p>Price: $60.00 </p>
        <br><br>
    </div>
    ...
    <!--third product-->
    <div class="ProductPage">
        <img src="images/H 02.jpg">
        <br>
        <a href="http://localhost:7331/part3/product.php?id=17"> Butterfly Hair Clips </a>
        <p>Price: $110.00 </p>
