...
<body>
    ...
    <!--women all products-->
    <div class="submenues">
        <!--Section for woman's hair clips-->
        <li><a href="http://localhost:7331/part3/Women%20Bag.php">Womens Bags</a></li>
    </div>
    <div class="submenues">
        <!--Section for womans's Jewellery-->
        <li><a href="http://localhost:7331/part3/Jewellery.php">Jewelry</a></li>
    </div>
    <div class="submenues">
        <!--Section for woman's hair clips-->
        <li><a href="http://localhost:7331/part3/Hair%20Clips.php">Hair Clips</a></li>
    </div>

    <div class="salesTitle">
        <h3>CHECK OUT THE WOMENS APPAREL</h3>
    </div>
