...
<head>
    <!--header-->
    <title>ADD-ON : Kids' Hair Bands </title>
</head>
...
<body>
    ...
    <!--kid's hair band products-->
    <div class="ProductPage">
        <!--first product-->
        <img src="images/kids hair bands1.jpg" alt="hair bands" title="Hair Bands">
        <br>
        <a href="http://localhost:7331/part3/product.php?id=20">Sun Flower</a>
        <p> Price:$54.25 </p>
    ...
    <div class="ProductPage">
        <!--second product-->
        <img src="images/kids hair bands2.jpg" alt="hair bands" title="Hair Bands">
        <br>
        <a href="http://localhost:7331/part3/product.php?id=21">Red Flower</a>
        <p>Price:$31.05 </p>
        <br><br>
    ...
    <div class="ProductPage">
        <!--third product-->
        <img src="images/kids hair bands3.jpg" alt="hair bands" title="Hair Bands">
        <br>
        <a href="http://localhost:7331/part3/product.php?id=22">Purple Blossoms</a>
        <p>Price: $50.99 </p>
